...
# NOTE: save_pnas() is defined in theme_pnas.R (the canonical version).
# A duplicate was removed here to prevent interface conflicts (the two versions
# used different type names, DPI settings, and path handling).
